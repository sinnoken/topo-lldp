...
function getInitialData() {
    ...
    return {
        ...
        edges: [
            ...
            { "from": "DC1_CORE_SW_01", "to": "DC2_DIST_SW_01", "labelFrom": "xe-1/1", "labelTo": "uplink", "label": "vlan: 10", "vlan_ids": [10], "width": 3, "color": { "color": "#10B981" } },
            { "from": "DC1_CORE_SW_02", "to": "DC2_DIST_SW_02", "labelFrom": "xe-1/1", "labelTo": "uplink", "width": 3, "color": { "color": "#10B981" } },
            { "from": "DC1_CORE_SW_01", "to": "DC3_DIST_SW_01", "labelFrom": "xe-1/2", "labelTo": "uplink", "label": "vlan: 10", "vlan_ids": [10], "width": 3, "color": { "color": "#10B981" } },
            { "from": "DC1_CORE_SW_02", "to": "DC3_DIST_SW_02", "labelFrom": "xe-1/2", "labelTo": "uplink", "width": 3, "color": { "color": "#10B981" } },
            { "from": "DC2_DIST_SW_01", "to": "DC2_SRV_PROD_01", "labelFrom": "ge-0/1", "labelTo": "eth0", "label": "vlan: 20", "vlan_ids": [20] },
            { "from": "DC2_DIST_SW_02", "to": "DC2_SRV_PROD_02", "labelFrom": "ge-0/1", "labelTo": "eth0", "label": "vlan: 70", "vlan_ids": [70] },
            { "from": "DC3_DIST_SW_01", "to": "DC3_SRV_DR_01", "labelFrom": "ge-0/1", "labelTo": "eth0", "label": "vlan: 20", "vlan_ids": [20] },
            { "from": "DC3_DIST_SW_02", "to": "DC3_SRV_DR_02", "labelFrom": "ge-0/1", "labelTo": "eth0", "label": "vlan: 60", "vlan_ids": [60] },
            { "from": "DC1_CORE_SW_01", "to": "DC4_ACC_SW_01", "labelFrom": "ge-1/1", "labelTo": "uplink", "label": "vlan: 40", "vlan_ids": [40] },
            { "from": "DC1_CORE_SW_02", "to": "DC4_ACC_SW_02", "labelFrom": "ge-1/1", "labelTo": "uplink", "label": "vlan: 60", "vlan_ids": [60] },
            { "from": "DC1_CORE_SW_01", "to": "DC5_ACC_SW_01", "labelFrom": "ge-1/2", "labelTo": "uplink", "label": "vlan: 30", "vlan_ids": [30] },
            { "from": "DC1_CORE_SW_02", "to": "DC5_ACC_SW_02", "labelFrom": "ge-1/2", "labelTo": "uplink", "label": "vlan: 80", "vlan_ids": [80] },
            { "from": "DC4_ACC_SW_01", "to": "DC4_DEV_NODE_01", "labelFrom": "p10", "labelTo": "nic", "label": "vlan: 40", "vlan_ids": [40] },
            { "from": "DC4_ACC_SW_02", "to": "DC4_DEV_NODE_02", "labelFrom": "p10", "labelTo": "nic", "label": "vlan: 50", "vlan_ids": [50] },
            { "from": "DC5_ACC_SW_01", "to": "DC5_IOT_01", "labelFrom": "p20", "labelTo": "dhcp", "label": "vlan: 30", "vlan_ids": [30] },
            { "from": "DC5_ACC_SW_02", "to": "DC5_IOT_02", "labelFrom": "p20", "labelTo": "dhcp", "label": "vlan: 80", "vlan_ids": [80] }
        ]
    };
}
